    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow">
        <Routes>
          ...
          <Route path="/checkout" element={<PrivateRoute><CheckoutDetailsPage /></PrivateRoute>} />
          ...
          <Route path="/jewelry" element={<PrivateRoute><JewelryPage /></PrivateRoute>} />
          <Route path="/mens-clothing" element={<PrivateRoute><MensClothingPage /></PrivateRoute>} />
          <Route path="/womens-clothing" element={<PrivateRoute><WomensClothingPage /></PrivateRoute>} />
          <Route path="/electronics" element={<PrivateRoute><ElectronicsPage /></PrivateRoute>} />
